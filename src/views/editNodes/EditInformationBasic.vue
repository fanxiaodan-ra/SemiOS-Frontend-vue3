  ...
  <v-card class="mx-auto my-pd24 my-mw80 my-mgt24 my-mgb24" elevation="16">
    ...
    <v-form ref="formRef">
      ...
      <UploadImg
        ...
        ref="childRef"
        left-width="160px"
        input-name="Nodes Logo"
        :tooltipText="logoText"
        :imgSize="5"
        :imgUrl="props.dataObj.daoLogoUrl"
      />
      <FormRow
        input-name="Nodes Manifesto"
        :isIcon="false"
        leftWidth="160px"
        :importance="false"
      >
        <v-textarea
          ...
          counter
          label="Please enter your Nodes manifesto, Markdown syntax is supported."
          :rules="manitestoRules"
        ></v-textarea>
      </FormRow>
      <FormRow
        input-name="Nodes Description"
        :isIcon="false"
        leftWidth="160px"
        :importance="false"
      >
